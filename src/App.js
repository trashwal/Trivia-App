  ...
  return (
    ...
    >
      ...
      <svg className="blobs blob-2" xmlns="http://www.w3.org/2000/svg">
        <path d="M 52 -66 C 65 -56 68 -32 64 -9 C 63 8 63 16 60 63 C 50 70 27 72 10 74 C -1 75 -9 76 -27 77 C -65 81 -81 65 -80 46 C -80 29 -71.7 8.1 -62 -4.7 C -52.3 -17.6 -38.5 -23.5 -27.5 -33.8 C -16.4 -44.2 -8.2 -59 6.6 -66.8 C 21.3 -74.6 42.7 -75.4 52 -66 Z" />
      </svg>
      <Nav
        started={started}
